# Deep Reinforcement Learning: Training Agents on Specified Tasks / Udacity Project #1
## Introduction
...
## Results
In this repository, I have included the saved model weights and learning curve plot for the most succesful agent.  The environment was able to be solved within 292 episodes utilizing a Deep Q Network for action predictions.
